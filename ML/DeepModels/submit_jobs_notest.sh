...
do
    ...
    do
        ...
        sbatch -J ${baseJobName} --output="rc_log_notest/${PrIdx}_${model_num}.o" --error="rc_log_notest/${PrIdx}_${model_num}.e" --mem=16G -n 1 -t 2-8:0:0 -p tier3 -A riteyes --gres=gpu:1 --mail-user=rsk3900@rit.edu --mail-type=ALL command.lock
    done
done
